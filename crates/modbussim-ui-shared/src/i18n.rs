...
fn tr_zh(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "err.slave_not_found_fmt" => "从站 {} 未找到",
        "err.add_slave_failed_fmt" => "新增从站失败: {}",
        "err.remove_slave_failed_fmt" => "删除从站失败: {}",
        "err.range_too_large_fmt" => "范围过大（最多 50000，当前 {}）",
        "err.add_default_device_failed_fmt" => "添加默认设备失败: {}",
        "err.auto_start_failed_fmt" => "自动启动失败: {}",
        "err.start_failed_fmt" => "启动失败: {}",
        "err.stop_failed_fmt" => "停止失败: {}",
        "err.load_device_failed_fmt" => "加载设备失败: {}",
        "slave.default_name_fmt" => "从站 {}",
        "dlg.batch.will_add_fmt" => "将添加 {} 个条目",
...
fn tr_en(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "err.slave_not_found_fmt" => "Slave {} not found",
        "err.add_slave_failed_fmt" => "Add slave failed: {}",
        "err.remove_slave_failed_fmt" => "Remove slave failed: {}",
        "err.range_too_large_fmt" => "Range too large (max 50000, got {})",
        "err.add_default_device_failed_fmt" => "Add default device failed: {}",
        "err.auto_start_failed_fmt" => "Auto-start failed: {}",
        "err.start_failed_fmt" => "Start failed: {}",
        "err.stop_failed_fmt" => "Stop failed: {}",
        "err.load_device_failed_fmt" => "Load device failed: {}",
        "slave.default_name_fmt" => "Slave {}",
        "dlg.batch.will_add_fmt" => "Will add {} entries",
